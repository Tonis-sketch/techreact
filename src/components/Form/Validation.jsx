      ...
      <div className="flex flex-col justify-center items-center font-pop w-full h-screen sm:mb-[10rem]">
        <div className="w-4/5  flex flex-col justify-center items-center mt-[10rem] sm:mt-[5rem] xs:-mt-[2rem] ">
          <img
            src={envelop}
            alt="mail"
            className="w-[600px] opacity-5 absolute  xs:hidden"
          />
          <div className="grid grid-cols-2 md:-mt-[15rem] md:-mx-[3rem] xs:-mx-10 xm:-mt-[10rem] xs:-mt-[4rem] sm:grid-cols-1 xs:grid-cols-1 items-center justify-between">
